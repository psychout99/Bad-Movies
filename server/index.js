...
var app = express();
var {getMoviesByGenre, getMoviesByTitle} = require('./helpers/apiHelpers.js');
var schema = require('../db/mongodb/index.js');
...
app.get("/genres", function(req, res) {
  getMoviesByGenre(req.query.genre, (data) => {
    res.send(data);
  });
...
app.get("/search", function(req, res) {
  getMoviesByTitle(req.query.title, (data) => {
    res.send(data);
  });
